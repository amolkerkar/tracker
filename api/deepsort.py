...
from facesaver.facesave import FaceSaver

# output_folder= r"./data/Faces/"
...
class DeepSORTTracker:
    ...
    def track(self, frame: np.ndarray, bboxes: np.ndarray, scores: np.ndarray) -> None:
        ...
        for track in self.tracker.tracks:
            ...
            facesaver = FaceSaver()
            # FaceSaver.IDwisesave(frame, id= track.track_id, bbox, output_folder = r"./data/Faces/" )
            facesaver.IDwisesave(frame, track.track_id, bbox, r"./data/Faces/")
